...
(function (a, b) {
  ...
  function bC (a, b, c) {
    ...
    if (d > 0) {
      if (c !== 'border') {
        for (; g < h; g++) {
          c || (d -= parseFloat(f.css(a, 'padding' + e[g])) || 0), c === 'margin'
    ...
    if (c) {
      for (; g < h; g++) {
        d += parseFloat(f.css(a, 'padding' + e[g])) || 0, c !== 'padding' && (d += parseFloat(
    ...
    data   : function (a, c, d, e) {
      if (!!f.acceptData(a)) {
        ...
        if (typeof c == 'object' || typeof c == 'function') {
          e ? m[n] = f.extend(m[n], c) : m[n].data = f.extend(
            m[n].data, c)
        }
        ...
        if (this.length) {
          ...
          if (this[0].nodeType === 1 && !f._data(this[0], 'parsedAttrs')) {
            ...
            for (var i = 0, j = e.length; i < j; i++) {
              g = e[i].name, g.indexOf('data-') === 0 && (g = f.camelCase(
  ...
  f.fn.extend({
    ...
    removeAttr: function (a, b) {
      ...
      if (b && a.nodeType === 1) {
        ...
        for (; h < g; h++) {
          e = d[h], e && (c = f.propFix[e] || e, f.attr(a, e, ''), a.removeAttribute(
    ...
    dispatch   : function (c) {
      ...
      if (e && !c.target.disabled && (!c.button || c.type !== 'click')) {
        ...
        for (l = c.target; l != this; l = l.parentNode || this) {
          o = {}, q = [], m[0] = l
          for (j = 0; j < e; j++) {
            r = d[j], s = r.selector, o[s] === b && (o[s] = r.quick ? H(l, r.quick) : m.is(
              s)), o[s] && q.push(r)
          }
          ...
          if ((f = o.leftMatch[h].exec(a)) != null && f[2]) {
            ...
            if (f) {
              for (n = 0; (j = s[n]) != null; n++) {
                j && (i = k(j, f, n, s), p = e ^ i, d && i != null ? p ? g = !0
  ...
  f.fn.extend({
    ...
    animate: function (a, b, c, d) {
      function g () {
        ...
        for (i in a) {
          j = new f.fx(this, b, i), h = a[i], cn.test(h) ? (o = f._data(this, 'toggle' + i) || (h
                                                                                                === 'toggle'
