...
(function (a, b) {
  ...
  var f = (function () {
    ...
    var v = /-([a-z]|[0-9])/ig
    var w = /^-ms-/
    var x = function (a, b) { return (b + '').toUpperCase() }
    var y = d.userAgent
    var z
    var A
    var B
    ...
    e.fn = e.prototype = {
      ...
      map          : function (a, c, d) {
        ...
        var i = 0
        var j = a.length
        var k = a instanceof e || j !== b && typeof j === 'number' && (j > 0 && a[0] && a[j - 1] || j === 0
                || e.isArray(
            a))
        if (k) {
          for (; i < j; i++) {
      ...
      proxy        : function (a, c) {
        ...
        var g = function () { return a.apply(c, f.concat(F.call(arguments))) }
  ...
  var I = function (a) { return f.event.special.hover ? a : a.replace(B, 'mouseenter$1 mouseleave$1') }
  f.event = {
    ...
    var d = 0
    var e = function (a) { f.event.simulate(b, a.target, f.event.fix(a), !0) }
    f.event.special[b] = {
    ...
    var p = o.match.POS
    var q = function (a, b) { return '\\' + (b - 0 + 1) }
      ...
      for (var j = 0, k; (k = a[j]) != null; j++) {
        ...
        if (typeof k === 'string') {
          if (!_.test(k)) {
            ...
            if (!f.support.tbody) {
              var p = $.test(k)
              var q = l === 'table' && !p ? o.firstChild && o.firstChild.childNodes : m[1] === '<table>' && !p
                ? o.childNodes : []
