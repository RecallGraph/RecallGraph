...
const { SYNC_TYPES: { EXISTING, DELETED } } = require('../operations/sync/helpers')
...
const typeSchema = Joi.array().items(Joi.string().valid(EXISTING, DELETED)).min(1).max(2).unique().required()
