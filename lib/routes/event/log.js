  ...
  return endpoint
    ...
    .queryParam(
      ...
      joi
        ...
        .valid('asc', 'desc')
        .optional(),
      'The primary sort order of records in the result set, sorted by `event.ctime`(groupBy=null) or aggregation key' +
      ' (groupBy is not null and countsOnly is false) or aggregated total (groupBy is not null and countsOnly is true).' +
    ...
    .queryParam(
      ...
      joi
        ...
        .valid('asc', 'desc')
        .optional(),
      'The secondary sort order of records in a group (if "groupBy" is specified and "countsOnly" is falsey), sorted' +
      ' by `event.ctime`. Default: "desc".'
    )
    .queryParam(
      'groupSkip',
      joi
