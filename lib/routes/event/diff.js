...
function buildEndpoint (endpoint) {
  return endpoint
    .queryParam('since', joiCG.number().precision(5).optional(), dd`
    ...
    .queryParam('until', joiCG.number().precision(5).optional(), dd`
    ...
    .queryParam('sort', joiCG.string().valid('asc', 'desc').optional(),
    ...
    .queryParam('reverse', joiCG.boolean().optional(), dd`
