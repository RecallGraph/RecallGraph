...
module.exports = (router) => {
  router.put('/:collection',
    ...
    .queryParam('returnNew', joi.boolean().optional(), 'Whether to return the newly updated object. Default `false`')
    .queryParam('returnOld', joi.boolean().optional(), 'Whether to return the old object. Default `false`')
