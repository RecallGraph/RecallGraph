...
const { DB_OPS: { REPLACE }, COLL_NAME_REGEX } = require('../../constants')
...
module.exports = router => {
  router.put('/:collection', verifyCollection, function (req, res) {
    let result
    ...
    .queryParam('ignoreRevs', Joi.boolean(),
      'Whether to ignore a revision match before replace. Default `true`.')
