...
module.exports = (router) => {
  router.put('/:collection',
    ...
    .pathParam('collection', joi.string().required(), 'The collection into which to replace the node.')
    .body(schema, 'The JSON object to persist.')
    ...
    .summary('Replace a node (document or edge).')
