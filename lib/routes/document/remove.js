...
const {
  removeSingle,
  removeMultiple
} = require("../../handlers/removeHandlers");
const {
  DB_OPS,
  COLL_NAME_REGEX,
  DOC_KEY_REGEX,
...
module.exports = router => {
  router
    ...
    .response(
      200,
      ["application/json"],
      "The remove call succeeded. For multiple docs, this is returned only if" +
    ...
    .error(
      412,
      "One or more documents could not be removed (due to a conflict or some other failed pre-condition)." +
