...
module.exports = router => {
  router
    ...
    .response(
      201,
      ["application/json"],
      "The create call succeeded. For multiple docs, this is returned only if" +
    ...
    .error(
      412,
      "One or more documents could not be created (due to a conflict or some other failed pre-condition)." +
