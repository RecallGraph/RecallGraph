...
const { DB_OPS: { INSERT }, DOC_ID_REGEX, COLL_NAME_REGEX } = require('../../constants')
...
const arrSchema = joi.array().items(objSchema.required()).min(1)
const reqBodySchema = joi.alternatives().try(objSchema, arrSchema).required()
