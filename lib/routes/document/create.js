  ...
  router.post('/:collection',
    ...
    function (req, res) {
      ...
      if (Array.isArray(req.body)) {
        result = createHandlers.createMultiple(req, req.queryParams);
      } else {
        try {
          result = createHandlers.createSingle(req, req.queryParams);
        } catch (e) {
    ...
    // .queryParam('returnNew', joi.boolean().optional(), 'Whether to return the newly created object.')
