...
module.exports = (router) => {
  router.patch('/:collection',
    ...
    .response(200, ['application/json'], 'The replace call succeeded. For multiple docs, this is returned only if' +
    ...
    .error(412, 'One or more documents could not be replaced (due to a conflict or some other failed pre-condition).' +
