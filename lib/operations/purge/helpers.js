...
function removeSkeletonVertices (vids) {
  ...
  return instrumentedQuery(query, 'removeSvQuery', cto)
}
...
function removeSkeletonEdgeHubs (eids) {
  ...
  return instrumentedQuery(query, 'removeSehQuery', cto)
}
...
function removeSkeletonEdgeSpokes (sehIds) {
  ...
  return instrumentedQuery(query, 'removeSeSQuery', cto)
}
...
function removeSnapshots (nids) {
  ...
  return instrumentedQuery(query, 'removeSsQuery', cto)
}
...
function removeSnapshotLinks (sids) {
  ...
  return instrumentedQuery(query, 'removeSlQuery', cto)
}
...
function removeEventSnapshotLinks (sids) {
  ...
  return instrumentedQuery(query, 'removeEslQuery', cto)
}
...
function removeCommands (eids) {
  ...
  return instrumentedQuery(query, 'removeCommandsQuery', cto)
}
