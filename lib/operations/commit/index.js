...
function commit (collName, node, op, { returnNew = false, returnOld = false, silent = false } = {},
  options = {}) {
  const result = executeTransaction({
    ...
    action: params => {
      ...
      const {
        DB_OPS: { INSERT, REPLACE, REMOVE, UPDATE, RESTORE }, COLLECTION_TYPES, getCollectionType
      } = require('../../helpers')
      const {
