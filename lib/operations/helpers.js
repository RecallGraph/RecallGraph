...
const {
  difference, values, chain, concat, find, isString, stubFalse, negate, identity, isFunction, memoize, remove
} = require('lodash')
...
exports.buildNodeIdGroupsByType = function buildNodeIdGroupsByType (path, types = { vertices: [], edges: [] }) {
...
exports.buildNodeGroupsByType = function buildNodeGroupsByType (timestamp, types, vFilter, eFilter) {
  const built = {
    vertices: [],
    edges: []
  }
