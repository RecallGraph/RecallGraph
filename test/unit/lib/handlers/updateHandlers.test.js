...
const { updateSingle, updateMultiple } = require('../../../../lib/handlers/updateHandlers');
...
describe('Update Handlers', () => {
  ...
  it('should fail when updating a vertex where ignoreRevs is false and _rev match fails', () => {
    ...
    expect(() => updateSingle({ pathParams, body: cnode }, { ignoreRevs: false })).to.throw().with.property(
  ...
  it('should update a vertex where ignoreRevs is false and _rev matches', () => {
    ...
    const rnode = updateSingle({ pathParams, body: cnode }, { returnNew: true, ignoreRevs: false }).new;
  ...
  it('should update a single vertex where ignoreRevs is true, irrespective of _rev', () => {
    ...
    const rnode = updateSingle({ pathParams, body: cnode }, { returnNew: true, ignoreRevs: true }).new;
  ...
  it('should fail when updating an edge where ignoreRevs is false and _rev match fails', () => {
    ...
    expect(() => updateSingle({ pathParams, body: ecnode }, { ignoreRevs: false })).to.throw().with.property(
      'errorNum', ARANGO_ERRORS.ERROR_ARANGO_CONFLICT.code);
  });
  ...
  it('should update an edge where ignoreRevs is false and _rev matches', () => {
    ...
    const ernode = updateSingle({ pathParams, body: ecnode }, { returnNew: true, ignoreRevs: false }).new;
  ...
  it('should update an edge where ignoreRevs is true, irrespective of _rev', () => {
    ...
    const ernode = updateSingle({ pathParams, body: ecnode }, { returnNew: true, ignoreRevs: true }).new;
